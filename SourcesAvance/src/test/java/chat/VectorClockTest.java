...
public class VectorClockTest {
	...
	public void testClone() throws Exception {
		...
		vc2.setEntry(1, 1);
		Assert.assertEquals(1, vc2.getEntry(1));
		Assert.assertEquals(0, vc1.getEntry(1));
		VectorClock vc3 = (VectorClock) vc2.clone();
		Assert.assertEquals(0, vc2.getEntry(0));
		Assert.assertEquals(1, vc2.getEntry(1));
		Assert.assertEquals(0, vc3.getEntry(0));
		Assert.assertEquals(1, vc3.getEntry(1));
	}
