 ...
 * 
 */
public class ThreadReadMessagesFromNetwork implements Runnable {
	/**
	 ...
	 */
	public ThreadReadMessagesFromNetwork(final Server server,
		...
		this.selector = Optional.ofNullable(selector)
				.orElseThrow(IllegalArgumentException::new);
		this.acceptClientKey = Optional.ofNullable(acceptClientKey)
				.orElseThrow(IllegalArgumentException::new);
		this.listenChanClient = Optional.ofNullable(listenChanClient)
				.orElseThrow(IllegalArgumentException::new);
		this.acceptServerKey = Optional.ofNullable(acceptServerKey)
				.orElseThrow(IllegalArgumentException::new);
		this.listenChanServer = Optional.ofNullable(listenChanServer)
				.orElseThrow(IllegalArgumentException::new);
